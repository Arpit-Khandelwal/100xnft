...
export async function createNFT(userPublicKey:string)
{
  ...
  const collectionAddress =  publicKey("Crr5Lz4zCNGEufhFLWivkhbP7FKTgNDFhkYpMDXdbVkL");
  ...
  return createdNft.mint.publicKey
}